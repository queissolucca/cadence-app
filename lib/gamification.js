...
// Patentes (ranks) = a jornada do aprendiz ao nativo do inglês. min = XP pra
// entrar na patente.
const RANKS = [
  { name: 'Aprendiz', icon: '🌱', min: 0 }, // começando do zero
  { name: 'Iniciante', icon: '📖', min: 300 }, // primeiras frases
  { name: 'Comunicador', icon: '💬', min: 800 }, // já se vira
  { name: 'Conversador', icon: '🗣️', min: 1600 }, // mantém o papo
  { name: 'Fluente', icon: '⭐', min: 3000 }, // solta a língua
  { name: 'Bilíngue', icon: '🌎', min: 5000 }, // já pensa em inglês
  { name: 'Nativo', icon: '👑', min: 8000 }, // soa como gente de lá
];
