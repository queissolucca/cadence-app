...
export const CONVITE = Object.freeze({
  [FALA]: {
    titulo: 'Falar com a Cady é do plano Pro',
    linha: 'Você pode escrever a vontade, fica liberado para você praticar. A '
      + 'conversa por voz, que é como você realmente aprende a conversar e a '
      + 'pronúncia destrava, é do plano Pro. A Cady vai te ouvir, corrigir na '
      + 'hora e trazer de volta amanhã o que você travou hoje. Além de lembrar '
      + 'dos objetivos e planos. Experimente já agora e aproveite!',
  },
  [TRILHA]: {
    titulo: 'A Trilha é do plano Pro',
    linha: 'Conversa Aberta te ensina o que você já sabe pedir. A trilha te '
      + 'direciona para você aprender com um caminho mais claro e com mais '
      + 'objetivo! Na ordem que faz você avançar passo a passo.',
  },
});
