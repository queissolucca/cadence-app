...
// Por ora só a Cady (a teacher principal). Especialistas (corrida, finanças,
// recrutadora…) entram aqui depois, cada um com seu agente/override e voz.
/* As vozes que a pessoa pode escolher na aba Conversar.

   Este arquivo é importado por componente de cliente, então aqui só entra
   METADADO — nome, papel, cor. O id do agente no ElevenLabs mora em
   lib/agentesVoz.js, que é só servidor: mandar o id pro navegador deixaria
   qualquer pessoa logada abrir qualquer agente da conta com um parâmetro de
   query, e cada minuto desses é cobrado.

   `id` aqui é a CHAVE que a rota do signed URL traduz — precisa bater com a de
   lá. */
export const AGENTS = [
  { id: 'cadi', name: 'Cady', role: 'The English Teacher', accent: '#2E9E5B' },
  // A mesma Cady, com a mão mais leve: corrige menos no meio da frase e deixa a
  // conversa respirar. Pra quem trava quando é interrompido — que é, segundo o
  // próprio funil, o bloqueio mais escolhido.
  { id: 'tranquila', name: 'Cady Tranquila', role: 'The Soft English Teacher', accent: '#5FBFB4' },
];
