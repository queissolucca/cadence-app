...
import { acessoPagoDe } from './acessoPago';
...
export const temPlanoCompleto = cache(async () => {
  ...
  const supabase = createClient();
  /* A regra mora em lib/acessoPago.js, junto com a dos outros três leitores.
     Aqui a dúvida vira FALSE: errar pra menos mostra um cadeado a quem pagou,
     e a pessoa recarrega; errar pra mais abre a voz de graça, e cada minuto de
     ElevenLabs custa. */
  return (await acessoPagoDe(supabase, eu.email)) === true;
});
