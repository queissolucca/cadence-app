...
Gere 1-2 "drills" curtíssimos pra fixar o MESMO padrão AGORA, em contextos diferentes entre si e diferentes do exercício original (nunca repita o cenário). Cada drill: "prompt" é uma situação em português em uma frase (ex: "seu chefe pediu pra terminar até sexta"), pedindo pro aluno responder com 1 frase curta em inglês aplicando o padrão. "hint" é o mesmo chip curtíssimo de estrutura-alvo (até 4 palavras, ex: "use: by + prazo").`;
